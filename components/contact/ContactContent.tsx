              ...
              <div className="space-y-5">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed max-w-none" style={{ color: "#4a5f7a" }}>{it("address.value")}</p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <a href={`tel:${it("phone.value")}`} className="text-sm transition-colors" style={{ color: "#4a5f7a" }} onMouseEnter={e=>(e.currentTarget as HTMLElement).style.color="#7a5a0a"} onMouseLeave={e=>(e.currentTarget as HTMLElement).style.color="#4a5f7a"}>
                      {it("phone.value")}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${it("email.value")}`} className="text-sm transition-colors" style={{ color: "#4a5f7a" }} onMouseEnter={e=>(e.currentTarget as HTMLElement).style.color="#7a5a0a"} onMouseLeave={e=>(e.currentTarget as HTMLElement).style.color="#4a5f7a"}>
                      {it("email.value")}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <a href="https://line.me/R/ti/p/@aspakglobal" target="_blank" rel="noopener noreferrer"
                      className="text-sm transition-colors" style={{ color: "#4a5f7a" }} onMouseEnter={e=>(e.currentTarget as HTMLElement).style.color="#06C755"} onMouseLeave={e=>(e.currentTarget as HTMLElement).style.color="#4a5f7a"}
                      {it("line.value")}
                    </a>
                  </div>
                </div>
