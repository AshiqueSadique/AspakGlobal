...
export default function ContactContent() {
  ...
  const inputClass = (field: string) =>
    `w-full px-4 py-3 rounded-lg border text-sm text-[--grey-800] placeholder-[--grey-400] transition-colors outline-none focus:ring-2 focus:ring-[--gold-400] ${
      errors[field]
        ? "border-red-400 bg-red-50"
        : "border-[--grey-200] bg-white focus:border-[--gold-400]"
    }`;
      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-14">
          ...
          <div className="lg:col-span-3">
            <h2 className="font-display font-bold text-[--navy-900] mb-8">{ft("heading")}</h2>
            ...
            {formState === "success" ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                {/* Name */}
                <div>
                  <label className="block text-sm font-semibold text-[--grey-800] mb-1.5">{ft("name")} *</label>
                  <input
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block text-sm font-semibold text-[--grey-800] mb-1.5">{ft("email")} *</label>
                    <input
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-[--grey-800] mb-1.5">{ft("phone")}</label>
                    <input
          ...
          <div className="lg:col-span-2 space-y-8">
            <div>
              <h2 className="font-display font-bold text-[--navy-900] mb-6">{it("heading")}</h2>
              <div className="space-y-5">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <div className="text-xs font-semibold text-[--gold-600] uppercase tracking-wider mb-1">{it("address.label")}</div>
                    <p className="text-sm text-[--color-text-muted] leading-relaxed max-w-none">{it("address.value")}</p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <div className="text-xs font-semibold text-[--gold-600] uppercase tracking-wider mb-1">{it("phone.label")}</div>
                    <a href={`tel:${it("phone.value")}`} className="text-sm text-[--color-text-muted] hover:text-[--gold-600] transition-colors">
                      {it("phone.value")}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <div className="text-xs font-semibold text-[--gold-600] uppercase tracking-wider mb-1">{it("email.label")}</div>
                    <a href={`mailto:${it("email.value")}`} className="text-sm text-[--color-text-muted] hover:text-[--gold-600] transition-colors">
                      {it("email.value")}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <div className="text-xs font-semibold text-[--gold-600] uppercase tracking-wider mb-1">{it("line.label")}</div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <div className="text-xs font-semibold text-[--gold-600] uppercase tracking-wider mb-1">{it("hours.label")}</div>
            ...
            <div>
              ...
              <div className="rounded-xl overflow-hidden border border-[--grey-200] shadow-sm aspect-video">
                <iframe
